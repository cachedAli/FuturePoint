          ...
          <div className="flex flex-col items-start">
            <motion.div variants={itemV}>
              <Link
                ...
                className="group inline-flex items-center gap-2 rounded-md bg-lime px-7 py-4 text-xs font-bold uppercase tracking-[0.16em] text-charcoal-deep transition-all duration-300 hover:-translate-y-0.5 hover:bg-lime-light hover:shadow-[0_12px_30px_-12px_rgba(151,197,11,0.5)]"
              >
                {displayCta.label}
