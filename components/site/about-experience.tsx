...
export function AboutExperience() {
  ...
  return <>
  <section className="overflow-hidden px-5 pt-[120px] sm:px-8 lg:px-12 lg:pt-[140px]"><div className="mx-auto max-w-[1440px]"><Reveal><p className="eyebrow">About Future Point</p><h1 className="page-title mt-5 max-w-[20ch] text-charcoal">Your Trusted Partner in Scalable IT Infrastructure &amp; Integration.</h1><p className="mt-6 max-w-[58ch] text-base leading-7 text-muted-foreground sm:text-lg sm:leading-8">Founded in <strong className="font-bold text-charcoal">2015</strong>, Future Point is a Pakistan-based IT systems integrator delivering networks, cybersecurity, data center and managed services from offices in Lahore, Karachi, Islamabad and Dubai.</p></Reveal></div></section>

  <section className="px-5 pt-16 sm:px-8 sm:pt-20 lg:px-12 lg:pt-20">
    <div className="mx-auto max-w-[1440px]">
      <div>
        <Reveal><p className="eyebrow">Our story & purpose</p><h2 className="section-title mt-5 max-w-[20ch] text-charcoal">Built to solve complex technology challenges.</h2></Reveal>
        <Reveal className="mt-6 max-w-[70ch]"><p className="text-lg leading-8 text-charcoal/75 sm:text-xl">Future Point brings enterprise business solutions, IT management systems and managed services under one accountable team. Its work is grounded in customer-centric delivery, technical excellence and long-term partnerships.</p></Reveal>
      </div>
  ...
  <section id="certifications" className="bg-offwhite px-3 pt-16 sm:px-4 sm:pt-20 lg:px-6 lg:pt-20">
    ...
    <div className="mx-auto max-w-[1440px]">
      <Reveal><p className="eyebrow">Expertise & certification</p><h2 className="section-title mt-5 max-w-[18ch] text-white">Certified expertise across the technology stack.</h2><p className="mt-6 max-w-[52ch] text-base leading-7 text-white/65 sm:text-lg sm:leading-8">Future Point&apos;s technical capability spans networking, security, infrastructure and professional delivery.</p></Reveal>
      ...
      <div className="mt-24 pt-16 lg:mt-28 lg:pt-20">
        <div className="grid gap-10 lg:grid-cols-[minmax(0,1.45fr)_minmax(300px,.85fr)] lg:items-center lg:gap-16">
          <Reveal><p className="eyebrow">Industry recognition</p><h2 className="section-title mt-5 max-w-[18ch] text-white">Recognized for the work behind the technology.</h2><p className="mt-6 max-w-[42ch] text-base leading-7 text-white/65 sm:text-lg sm:leading-8">Independent recognition of Future Point&apos;s technology delivery, partnerships and industry work.</p></Reveal>
